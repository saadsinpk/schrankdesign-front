...
export const DoorsAccordianAfter = ({ handleToggle, drawerlistUpdate, createDrawer, viewdata }) => {
  const baseUrl = import.meta.env.VITE_BACKEND_URL_img;
        ...
        <Form className="w-full">
          <div className="flex justify-between flex-wrap py-5 pl-5 pr-16 relative">
            ...
            <div className="flex flex-col mb-2  items-start gap-[20px]">
                ...
                <div className="w-[170px]">
                  <div className="relative">
                    ...
                    <div className="pointer-events-none absolute inset-y-0 right-0 flex  pr-3">
                      <p className="text-[16px] leading-[30px] font-[karla] font-normal">€/pcs</p>
                    </div>
                    <ErrorMessage
                      name={"price_einkauf"}
                      component="div"
              ...
              <div className="flex flex-row  mb-2  justify-between w-full gap-[25px]">
                <h1 className="font-[karla] text-[20px] font-medium">Price-Profit</h1>
                <div className="w-[170px]">
                  <div className="relative">
                    <Field
                      className="block text-[20px] leading-[30px] font-[karla] font-bold  outline-none w-full border border-solid border-black bg-[#F6F6F6] rounded-[3px] pl-3 pr-14"
                    ...
                    />
                    <div className="pointer-events-none absolute inset-y-0 right-0 flex  pr-3">
                      <p className="text-[16px] leading-[30px] font-[karla] font-normal">%</p>
                    </div>
                    <ErrorMessage
                      name={"price_aufschlag"}
                      component="div"
                  ...
                  <div className="flex flex-row justify-between gap-6">
                    ...
                    <h1 className="font-[karla] leading-[16px] font-semibold text-[18px]">
                      {(() => {
                        ...
                        const totalSalePrice = parseFloat((price_einkauf + (price_einkauf * price_aufschlag / 100)).toFixed(2));
                  ...
                  <div className="flex flex-row justify-between gap-6">
                    ...
                    <h1 className="font-[karla] leading-[16px] font-semibold text-[18px]">
                      {(() => {
                        const price_einkauf = +formik?.values?.price_einkauf || 0;
                        const price_aufschlag = +formik?.values?.price_aufschlag || 0;
                        const totalProfit = parseFloat((price_einkauf * price_aufschlag / 100).toFixed(2));
