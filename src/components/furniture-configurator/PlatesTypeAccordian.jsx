...
export const PlatesTypeAccordianBefore = ({ handleToggle, index, viewdata }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center gap-[15px] w-full flex-wrap justify-between" key={index} >
      <div>
        <div className="px-[12px] w-fit h-fit border border-solid border-black bg-[#F6F6F6] rounded-[3px]">
          <p className="text-[32px] leading-[30px] font-[karla] font-bold ">{viewdata?.configId && viewdata?.configId}</p>
        </div>
      </div>
...
const dropdownOptionsEdge = [
  { label: "V", icon: <div className="w-6 h-6 border-gray-600 border-b-4"></div> },
  { label: "H", icon: <div className="w-6 h-6 border-gray-600 border-t-4"></div> },
  { label: "R", icon: <div className="w-6 h-6 border-gray-600 border-r-4"></div> },
  { label: "L", icon: <div className="w-6 h-6 border-gray-600 border-s-4"></div> },
  { label: "VH", icon: <div className="w-6 h-6 border-gray-600 border-y-4 "></div> },
  { label: "VR", icon: <div className="w-6 h-6 border-gray-600 border-r-4 border-b-4"></div> },
  { label: "VL", icon: <div className="w-6 h-6 border-gray-600 border-l-4 border-b-4"></div> },
  { label: "HL", icon: <div className="w-6 h-6 border-gray-600 border-t-4 border-l-4"></div> },
  { label: "HR", icon: <div className="w-6 h-6 border-gray-600 border-t-4 border-r-4"></div> },
  {
    label: "LR",
    ...
    <Formik initialValues={platesTypesinitialValues} onSubmit={Handlesubmit} enableReinitialize>
      {(formik) => (
        <Form className="w-full relative">
          <div className="flex justify-between max-w-5xl flex-wrap py-5 pl-5 pr-16">
