  ...
  const handleDrag = useCallback(
    (state) => {
      ...
      if (intersects[0]) {
        ...
        if (leftWidth < Config.plate.minDoorLength) {
          leftWidth = Config.plate.minDoorLength
          rightWidth = totalWidth - leftWidth
        } else if (leftWidth > Config.plate.maxDoubleDoorLength) {
          leftWidth = Config.plate.maxDoubleDoorLength
          rightWidth = totalWidth - leftWidth
        } else if (rightWidth < Config.plate.minDoorLength) {
          rightWidth = Config.plate.minDoorLength
            ...
            <mesh
              ...
              position={[
                ...
                (baseType === Config.baseType.panel
                  ...
                  8,
                depth + Config.plate.thickness + 0.1,
              ]}
              visible={
                dragging
                  ? arrowIndex + 1 === index
