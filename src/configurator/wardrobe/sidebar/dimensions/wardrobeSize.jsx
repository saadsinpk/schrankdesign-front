...
export default function WardrobeSize() {
  ...
  const validateWidth = useCallback(
    (temp) => {
      if (temp < Config.plate.minWidth) {
        alert(
          "width should be greater than " +
            Config.plate.minWidth.toString() +
            "cm."
        )
        setTempWidth(Config.plate.minWidth.toString())
        handleWidth(Config.plate.minWidth)
