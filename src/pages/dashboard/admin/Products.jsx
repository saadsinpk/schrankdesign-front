...
import { DeleteSingleCategory, GetAllProduct } from "../../../api/api";
...
const Products = () => {
  ...
  const deleteCategory = async () => {
    ...
    const { data, error } = await DeleteSingleCategory(selectedDelete);
    if (data) {
                  ...
                  {products &&
                    products?.map((item) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">{item?.minDimension}</td>
                        <td className="px-6 py-4">{item?.maxDimension}</td>
