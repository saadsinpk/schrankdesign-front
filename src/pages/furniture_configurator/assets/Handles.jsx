        ...
        <Layout>
            <SubLayout tabs={tabs}>
                ...
                {(HandleList?.length > 0 && Array.isArray(HandleList)) &&
                    HandleList.map((item, index) => <Accordian afterCollapse={<HandlesAccordianAfter drawerlistUpdate={setHandleList} viewdata={item} />} beforeCollapse={<HandlesAccordianBefore viewdata={item} />} setState={setNewDrawer} />)
                }
            </SubLayout>
        </Layout>
    )
